...
const demandeStage = () => {
    return ( <
        ...
        <
        label
        for = "typeStage" > Type de stage < /label> <
        select className = 'demandeStage-select'
        name = "typeStage"
        id = "typeStage" >
        <
        option value = ""
        disabled selected > Choisissez un type < /option> <
        ...
        <
        label
        for = "domain" > Demain < /label> <
        select className = 'demandeStage-select'
        name = "domain"
        id = "domain" >
        <
        option value = ""
        disabled selected > Choisissez un domain < /option> <
        ...
        <
        label
        for = "domain" > Ville < /label> <
        select className = 'demandeStage-select'
        name = "domain"
        id = "domain" >
        <
        option value = ""
        disabled selected > Choisissez une ville < /option> <
        ...
        input className = 'demandeStage-input'
        type = "date" / >
        <
        /div>
